...
public class viewsWindow {
    ...
    public viewsWindow(PRANAYAMA prana) { // PRANAYAMA prana
...
//            System.out.println("inside viewsWindow");
    ...
    public void initBackgroundNumberView(JLabel label, Color colorDefault, Color colorNew) {
        if (pranaMain.colorsWindow == null) {
...
//        }
    ...
    public void getTransientValuesFromColorWindow() {
