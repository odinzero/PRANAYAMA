...
public class views {
    ...
    public JPanel p1, p2, p3, p4, p5, d1, d2, d3;
    public JLabel label_Inhalation, label_Exhalation,
            label_breathhold_after_inhalation, label_breathhold_after_exhalation;
    public JLabel divider1, divider2, divider3;
    public JLabel label_numCycles;

    public JPanel common, labelPanel;

    public graphComponents graphCompLine;
    ...
    // for NUMBER VIEW
    public views(PRANAYAMA prana, boolean isPreview, JPanel preview) {
        this.pranaMain = prana;
    ...
    public views(PRANAYAMA prana, boolean isPreview, JPanel preview, int type, int selectedIndex) { // PRANAYAMA prana,
//        this.pranaMain = prana;
        this.isPreviewMode = isPreview;
        this.previewPanel = preview;
...
//        c.weighty = 150;
    ...
    public void centerPanel(JPanel outside, JPanel inside) {
    ...
    public void setViewOpaque(boolean isOpaq) {
        this.isOpaque = isOpaq;
    }
    
     public boolean getViewOpaque() {
        return isOpaque;
    }
}
