...
import com.pranayama.ui.MyColorChooserUI;
import com.pranayama.ui.LeftRightSpinnerUI;
import com.pranayama.ui.MyCheckBoxUI;
import com.pranayama.basic.ILabel;
import com.pranayama.componentEditor;
import com.pranayama.gradientSampleIcon;
import com.pranayama.pattern.patternWindow;
import com.pranayama.previewColorPanel;
...
public class viewsColorWindow implements ILabel {
    ...
    public Color colorBackground, colorForeground;
    Color approvedColor;
    String colorChooserTitle;
    Font myFont;
    public JCheckBox box_useGradientOrNot, box_Opaque;
    JSpinner spinner_Gradient;
    public int indexGradient = -1;
    // important two state
    ...
    public viewsColorWindow(PRANAYAMA prana) { // PRANAYAMA prana
...
//==================== layout components ========================================        
    ...
    public void initialStateAllComponents() {
    ...
    public void removeAllMouseListeners(JComponent comp) {
...
//            g2.setPaint(new GradientPaint(0, 0, new Color(255, 242, 226), w, h, new Color(213, 255, 122), false));
    ...
    private void initColorChooser(String title) {
        ...
        colorChooser = colorChooser.setRadioButtonCover("com.pranayama.ui.MyRadioButtonUI", colorChooser);
        colorChooser = colorChooser.setSliderCover("com.pranayama.ui.MySliderUI", colorChooser);
        colorChooser = colorChooser.setSpinnerCover("com.pranayama.ui.LeftRightSpinnerUI", colorChooser);
        colorChooser = colorChooser.setTabbedPaneCover("com.pranayama.ui.MyTabbedPaneUI", colorChooser);
        // set PREVIEW PANEL
        colorChooser.setMyPreviewPanel(previewView.previewBasicPanel);
    ...
    public MouseAdapter choiceColor() {
    ...
    public void getSpinnerGradientValue() {
        for (int i = 0; i < ic.length; i++) {
            gradientSampleIcon sampleIcon = ic[i];
    ...
    public void resetPreviewPanel_andBorder(String borderName) {
...
//        colorChooser.resetBorder();
    ...
    public void changeFonts(final JComboBox combobox) {
