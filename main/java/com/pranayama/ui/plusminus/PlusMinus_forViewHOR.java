...
public class PlusMinus_forViewHOR {
    ...
    public int ww, hh;
    public int counterHOR;

    PRANAYAMA pranaMain;

    public PlusMinus_forViewHOR(PRANAYAMA prana) {
    ...
    public void setCounterHOR(int val) {
        this.counterHOR = val;
    }

    public int getCounterHOR() {
        return counterHOR;
    }
    ...
    public void limitationDecreaseRange(int index, int intervalWidth, int intervalHeight) {
     ...
     public int[] setDefaultPanelSize_forGraphHOR(int counter, JPanel p) {
