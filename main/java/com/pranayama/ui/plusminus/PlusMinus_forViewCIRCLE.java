...
public class PlusMinus_forViewCIRCLE {
    ...
    public int ww, hh;
    public int counterCIRCLE;
    public int fontSize;

    PRANAYAMA pranaMain;

    public PlusMinus_forViewCIRCLE(PRANAYAMA prana) {
    ...
    public void setCounterCIRCLE(int val) {
        this.counterCIRCLE = val;
    }

    public int getCounterCIRCLE() {
    ...
    public int[] setDefaultPanelSize_forGraphCIRCLE(int counter, JPanel p) {
