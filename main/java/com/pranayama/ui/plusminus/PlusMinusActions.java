...
//    Font numCyclesFont;
    public PlusMinus_forView1 forView1;
    public PlusMinus_forViewHOR forViewHOR;
    public PlusMinus_forViewVER forViewVER;
    public PlusMinus_forViewCIRCLE forViewCIRCLE;

    PRANAYAMA pranaMain;

    public PlusMinusActions(PRANAYAMA prana) {
