package com.pranayama.ui.plusminus;
...
public class PlusMinus_forViewVER {
    ...
    public int ww, hh;
    public int counterVER;

    PRANAYAMA pranaMain;

    public PlusMinus_forViewVER(PRANAYAMA prana) {
    ...
    public void increaseSizeGraphs(int index, int intervalWidth, int intervalHeight) {
...
//        pranaMain.view.graphCompLine.setYDelta((int) delta);
    ...
    public void decreaseSizeGraphs(int index, int intervalWidth, int intervalHeight) {
...
//                + "   " + pranaMain.view.graphCompLine.getBounds().height);
    ...
    public void setCounterVER(int val) {
        this.counterVER = val;
    }

    public int getCounterVER() {
        return counterVER;
    }

    public void setGraphWidthAndHeight(int line_w, int line_h) {
        pranaMain.view.graphCompLine.setGraphWidth(line_w);
        pranaMain.view.graphCompLine.setGraphHeight(line_h);
    }

    public void limitationIncreaseRange(int index, int intervalWidth, int intervalHeight) {
    ...
    public void limitationDecreaseRange(int index, int intervalWidth, int intervalHeight) {
    ...
    public int[] setDefaultPanelSize1_forGraphVER(int counter, JPanel p) {
    ...
    public int[] setDefaultPanelSize2_forGraphVER(int counter, JPanel p) {
    ...
    public int[] setDefaultPanelSize3_forGraphVER(int counter, JPanel p) {
