...
public class PlusMinus_forView1 {
    ...
    public PlusMinus_forView1(PRANAYAMA prana) {
    ...
    public void increaseFont(int index, int intervalWidth, int intervalHeight) {
...
// ------------- change size main panel ----------------------------------------
    ...
    //
    public void decreaseFont(int index, int intervalWidth, int intervalHeight) { // int widthLimit
// ------------- change font size labels ---------------------------------------        
...
//        int index = pranaMain.mainMenu.Breath.settingsBreath.schema_breathing.getSelectedIndex();
    ...
    public int[] setDefaultPanelSize1(int fontSize, JPanel p) {
    ...
    public int[] setDefaultPanelSize2(int fontSize, JPanel p) {
    ...
    public int[] setDefaultPanelSize3(int fontSize, JPanel p) {
