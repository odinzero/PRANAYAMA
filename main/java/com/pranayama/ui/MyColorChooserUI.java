...
public class MyColorChooserUI {
    ...
    public utils.buttonsWindow apply, cancel;
    public Font newFont;
    ...
    public MyColorChooserUI(String titl) { // PRANAYAMA prana,
        this.title = titl;
...
//        return gradPanel;
    ...
    public void setMyPreviewPanel(JPanel panel) {
        if (panel != null) {
            c.gridx = 0;
            c.gridy = 2;
            base.add(panel, c);
    ...
    public void removePreview(JPanel parent, JPanel child) {
    ...
    public MyColorChooserUI setRadioButtonCover(String str, MyColorChooserUI chooser) {
    ...
    public MyColorChooserUI setSliderCover(String str, MyColorChooserUI chooser) {
    ...
    public MyColorChooserUI setSpinnerCover(String str, MyColorChooserUI chooser) {
    ...
    public MyColorChooserUI setTabbedPaneCover(String str, MyColorChooserUI chooser) {
