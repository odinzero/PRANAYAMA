...
public class LightScrollPane extends JComponent {
    ...
    private static final int THUMB_SIZE = 12;// 8
    private static final Color THUMB_COLOR = Color.BLACK;  //BLACk
    ...
    private static class MyScrollBarUI extends BasicScrollBarUI {
     ...
     public static void main(String[] args) {
       ...
       // frame.setLayout(null); 
        ...
        frame.add(new LightScrollPane(content));
