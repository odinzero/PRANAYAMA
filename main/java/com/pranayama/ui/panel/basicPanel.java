package com.pranayama.ui.panel;
...
public class basicPanel extends JPanel {
    ...
    public basicPanel(PRANAYAMA main) {
        prana = main;
        this.setLayout(null);

        w = prana.frame.getWidth();
        h = prana.frame.getHeight();
        x = prana.frame.getLocation().x;
        y = prana.frame.getLocation().y;
    }
    
    public basicPanel(Component comp) { // PRANAYAMA main
       // prana = main;
        this.setLayout(null);
    ...
    public void paintComponent(Graphics g) {
        ...
        if(choice == 100) {
            g2.setPaint(getColorBackground());
        }
