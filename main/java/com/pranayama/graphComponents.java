...
import com.pranayama.util.HSLColor;
...
public class graphComponents extends JComponent implements MouseListener, FocusListener {
    ...
    public graphComponents(int t, int ind) {
        type = t;
        index = ind;
...
// " inhalation : hold : exhalation : hold " <-- selected index JCombobox 'schema_breathing'
    ...
    public Double[] convex_polygons(double x, double y, double w, double h, int n, int rotation) {
        // radius of polygon
        double r = w / 2;
    ...
    public void paintCounter(Graphics g, Font font, String TEXT, Color color1, Color color2,
    ...
    public void setBackgroundGraphComp(boolean bool) {
        this.isPaintBackground = bool;
    }

    public boolean getBackgroundGraphComp() {
    ...
    public Color getToneColor(Color rgb, int percent) {
