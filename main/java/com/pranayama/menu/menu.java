...
//    saveGame savegame;
    ...
    public  menuActions ma;
    
    public submenu_Help Help ;
    public submenu_Options Options;
    public submenu_Breath Breath;

    public menu(PRANAYAMA prana) {
